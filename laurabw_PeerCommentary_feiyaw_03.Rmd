...
3.For the histogram, you can add a normal curve on the graph to show the how the histogram compare with the normal distribution. You canrefer to Module 9 for the functions.
4. I see you use package sciplot to calculate the standard error. Graet way to solve it.
5. The distribution of Zombies_killed and year of education are Poisson distribution. However, if you sample them and take the mean of each sample, those means should be normal distribution. The histogram is not as helpful as QQ plot.you can also try to apply the QQ plot and you can see a clear normal distribution.  

...
At first, I think I made this way too hard, thinking I would need to write functions into the {ggplot} function.
But, then I realized that this is part of the awesomeness of {ggplot}, that it has built-in functions already and
knows what to do with the data when you ask it to create a boxplot based on specific variables. After looking
through older modules, this is what I came up with:

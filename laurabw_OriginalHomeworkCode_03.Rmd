...
Next up is weight. I am going to try to put all the code together to streamline the process:
...
Now we can move on to our two variables that are not normally distributed. We will 
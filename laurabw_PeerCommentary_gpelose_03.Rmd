---
title: "laurabw_PeerCommentary_gpelose_03"
author: "Greg Pelose"
date: "10/12/2019"
output: html_document
---
######Hi Laura, this is greg, all of my comments will be placed on the bottom of the document along with the line of code corresponding to it. 
---
title: "Zombie HW"
...
Gregs comments 
line 80
  Great job here finding the population standard deviation, this worked on my computer as well!
line 216
  great job with question one. 
line 241
  I am also not sure why your title is not centered, but other than that this looks very well done.
line 301.
  all of these graphs above look very good. I totally realized that I did not add titles or anything like that to my graphs... thanks for the reminder before I submit mine to the final draft. 
line 330
  I agree with you on the explanation of the second scattterplot.
line 394
  I did not have this realization when I did my assignemnt. I did not know to click to enlarge my image and take a closer look at the graphs to be able to detect skewness. So great job being able to detect that this is not "normal" but, unfortunately, I am also not sure which distribution this represents. After looking online as well I agree it might be "right skewed". 
550
  I struggled with number 5, I had a problem with finding the standard error. But after looking at your code everything ran very well on my console and looks good. I also am not sure as to why they both look so similar, I will also look into this and try and find out a solution but I do not have one right now. 
  
line 673
  Great job with this question, for age, messing around with the bin might not be a bad idea, I am curious as to what would come from the result of that. Other than that, you did a great job with this whole assignment. You have clearly put a ton of time and effort into this and it shows. Have a great day!!!
